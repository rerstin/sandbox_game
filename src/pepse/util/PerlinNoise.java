...
/**
 * implements PerlinNoise algorithm for random landscape.
...
public class PerlinNoise {
    ...
    /*
     * Initialize the permutation array and populate it.
     */
    private void init() {
        this.p = new int[512];
    ...
    /**
     * The main use of the PerlinNoise class. Generates noise from given x.
     * @param x to generate noise from
     * @return noise made by using x
     */
    public float noise(double x) {
        ...
        return value / initialSize * 250;
    }

    /*
     * smooths the noise, used in the noise function.
     */
